...
public class DestroyFundActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActivityDestroyFundBinding activitySeoBinding = DataBindingUtil.inflate(LayoutInflater.from(this), R.layout.activity_destroy_fund, mContentLyBase, true);
    ...
    private void bindViews() {
        ...
        findViewById(R.id.confirmBtn).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                PassWordDialog dialog = new PassWordDialog(DestroyFundActivity.this);
            ...
            public void onResponse(Call<BaseResponse<CommonResult>> call, Response<BaseResponse<CommonResult>> response) {
                Callback<JsonElement> callback = new Callback<JsonElement>() {
                    ...
                    public void onResponse(Call<JsonElement> call, Response<JsonElement> response) {
                        ...
                        ToastUtils.showLong(R.string.tx_successed);
                        DestroyFundActivity.this.finish();
                    }
