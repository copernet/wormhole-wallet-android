...
public class TabContainerView extends LinearLayout {
    ...
    public void showRedIcon(int index) {
        getChildAt(index).findViewById(R.id.redIconV).setVisibility(View.VISIBLE);
    }

    public void hideRedIcon(int index) {
        getChildAt(index).findViewById(R.id.redIconV).setVisibility(View.GONE);
    }
