...
import whc.com.whc_wallet.databinding.ItemCrowdBinding;
import wormhole.net.response.PropertyData;

/**
 * Created by chuanbei.qiao on 2018/10/24.
 */
public class ValidCrowdAdapter extends RecyclerView.Adapter<ValidCrowdAdapter.ViewHolder> {

    private List<PropertyData> mData;
    private Context mContext;
    private boolean mShowOperaly;

    public ValidCrowdAdapter(ArrayList<PropertyData> data, Context context, boolean isMine) {
        this.mData = data;
        mContext = context;
        mShowOperaly = isMine;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ItemCrowdBinding binding = DataBindingUtil.inflate(LayoutInflater.from(parent.getContext()), R.layout.item_crowd, parent, false);
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        private ItemCrowdBinding binding;

        public ItemCrowdBinding getBinding() {
            return binding;
        }

        public ViewHolder(ItemCrowdBinding binding) {
