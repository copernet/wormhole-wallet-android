...
import whc.com.whc_wallet.databinding.ActivityCreateManagableFundBinding;
...
public class CreateManagableActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActivityCreateManagableFundBinding activityCreateCrowdBinding = DataBindingUtil.inflate(LayoutInflater.from(this), R.layout.activity_create_managable_fund, mContentLyBase, true);
    ...
    private void bindViews() {
        setTilte(getString(R.string.create_managable_fund));
        bindSpinners();

        findViewById(R.id.confirmBtn).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                PassWordDialog dialog = new PassWordDialog(CreateManagableActivity.this);
    ...
    private void bindSpinners() {
        ...
        call.enqueue(new Callback<BaseResponse<Map<String, ArrayList<String>>>>() {
            ...
            public void onResponse(Call<BaseResponse<Map<String, ArrayList<String>>>> call, Response<BaseResponse<Map<String, ArrayList<String>>>> response) {
                ...
                //适配器
                ArrayAdapter arr_adapter = new ArrayAdapter<String>(CreateManagableActivity.this, android.R.layout.simple_spinner_item, data_list);
                //设置样式
    ...
    private void doTrade(final Storage storage) {
        ...
        Call<BaseResponse<CommonResult>> call = Retrofit.getRetrofit().getService().createManagableFunding(filedMap);
    ...
    class SpinnerSelectedListener implements AdapterView.OnItemSelectedListener {
        public void onItemSelected(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
            ...
            ArrayAdapter precAdapter = new ArrayAdapter<String>(CreateManagableActivity.this, android.R.layout.simple_spinner_item, precList);
            arr_adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
