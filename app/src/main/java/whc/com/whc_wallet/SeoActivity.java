...
import whc.com.whc_wallet.databinding.ActivitySeoBinding;
...
public class SeoActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActivitySeoBinding activitySeoBinding = DataBindingUtil.inflate(LayoutInflater.from(this), R.layout.activity_seo, mContentLyBase, true);
    ...
    private void bindViews() {
        setTilte(R.string.seo_fund);

        findViewById(R.id.confirmBtn).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                PassWordDialog dialog = new PassWordDialog(SeoActivity.this);
    ...
    private void doTrade(final Storage storage) {
        ...
        Call<BaseResponse<CommonResult>> call = Retrofit.getRetrofit().getService().seo(filedMap);
